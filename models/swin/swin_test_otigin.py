...
import argparse
from models.res_swin import Res_Swin_Stack
from models.utils.warmup_scheduler import GradualWarmupScheduler
...
def set_args():
    ...
    model_identifier = f"res_swin_stack_{s1_bands_indicator}_{s2_bands_indicator}"
    ...
    parser.add_argument('--encoder_name', default="res_swin_stack", type=str)
    ...
    models_path = r"C:\Users\lvblo\PycharmProjects\forestbiomass-lyu"
    ...
    parser.add_argument('--converted_training_features_path', default=str(osp.join(data_path, "forest-biomass")), type=str)
    parser.add_argument('--converted_testing_features_path', default=str(osp.join(data_path, "forest-biomass-test")), type=str)
    ...
    parser.add_argument('--submission_folder_path', default=str(osp.join(data_path, "imgs", "test_agbm_lyu")), type=str)
