...
class EfficientNet_v1(nn.Module):
    ...
    def __init__(self,  drop_connect_rate=0.2):
        ...
        for in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats in config1:
            ...
            blocks1.append(MBConvBlock(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, drop_rate))
            block_length+=1
            for _ in range(repeats-1):
                drop_rate = drop_connect_rate * (block_length / total_blocks)
                blocks1.append(MBConvBlock(out_channels, out_channels, kernel_size, 1, expand_ratio, se_ratio, drop_rate))
                block_length+=1
        ...
        for in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats in config2:
            # drop connect rate based on block index
            drop_rate = drop_connect_rate * (block_length / total_blocks)
            blocks2.append(MBConvBlock(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, drop_rate))
            block_length+=1
            for _ in range(repeats-1):
                drop_rate = drop_connect_rate * (block_length / total_blocks)
                blocks2.append(MBConvBlock(out_channels, out_channels, kernel_size, 1, expand_ratio, se_ratio, drop_rate))
                block_length+=1
        ...
        for in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats in config3:
            # drop connect rate based on block index
            drop_rate = drop_connect_rate * (block_length / total_blocks)
            blocks3.append(MBConvBlock(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, drop_rate))
            block_length+=1
            for _ in range(repeats-1):
                drop_rate = drop_connect_rate * (block_length / total_blocks)
                blocks3.append(MBConvBlock(out_channels, out_channels, kernel_size, 1, expand_ratio, se_ratio, drop_rate))
                block_length+=1
        ...
        for in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats in config4:
            # drop connect rate based on block index
            drop_rate = drop_connect_rate * (block_length / total_blocks)
            blocks4.append(MBConvBlock(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, drop_rate))
            block_length+=1
            for _ in range(repeats-1):
                drop_rate = drop_connect_rate * (block_length / total_blocks)
                blocks4.append(MBConvBlock(out_channels, out_channels, kernel_size, 1, expand_ratio, se_ratio, drop_rate))
                block_length+=1
