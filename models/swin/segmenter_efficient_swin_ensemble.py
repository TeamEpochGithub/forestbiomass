...
from models.utils.dataloading import SentinelTiffDataloader_all, SentinelTiffDataloaderSubmission_all
import operator
...
class Ensemble_Model(nn.Module):
    def __init__(self, path_efficient, path_resnet, args):
        super().__init__()
...
def set_args():
    ...
    model_identifier = f"efficientnet_swin_ensemble_{bands_to_keep_indicator}"
